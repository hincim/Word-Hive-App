...
import com.hakanninc.weatherapp.adapter.MovieAdapter
import com.hakanninc.weatherapp.event.MoviesEvent
import com.hakanninc.weatherapp.state.MoviesState
import com.hakanninc.weatherapp.viewmodel.MovieViewModel

class MovieFragment : Fragment(R.layout.fragment_movie), SearchView.OnQueryTextListener {
    private lateinit var _fragmentBinding: com.hakanninc.weatherapp.databinding.FragmentMovieBinding
